...
return [
     ...
     */
    /*
     * Die Portal-API liefert Datumswerte in gemischten Formaten: Laravel-JSON
     * (ISO 8601 mit Mikrosekunden und "Z"), ISO 8601 ohne Mikrosekunden sowie
     * "Y-m-d H:i" bei /api/meetup-events. Serialisiert wird im ersten Format.
     */
    'date_format' => [
        DATE_ATOM,
        'Y-m-d\TH:i:s.up',
