...
- [ ] 1.18 Finaler E2E-Test nach Deploy `76787a1`: voller Flow bis „Zurück zur App"-Tap auf der Handoff-Seite → App zeigt „verbunden" mit Profil. (4 Taps: Nostr → Amber signieren → Accept → Zurück zur App — Single-Device-NIP-55-Norm; später via Amber-„remember" reduzierbar.)
