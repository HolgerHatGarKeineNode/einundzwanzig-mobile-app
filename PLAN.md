...
- [ ] 1.19 Finaler E2E nach Deploy Portal `54c959d`: App „Mit Nostr" → Launcher „Mit Amber signieren" → Amber „Accept" → **App öffnet direkt** (einundzwanzig://signed) → Exchange → „verbunden" mit Satoshi-Profil. Nur noch 3 Taps, kein „Zurück zur App" mehr.
